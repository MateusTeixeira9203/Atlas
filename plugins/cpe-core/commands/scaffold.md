---
name: scaffold
description: Generate a project artifact from a CPE template. Lists available templates, asks which to apply, generates the output file(s) in the current project. Supports deck templates (html-deck-framework, kami-paper-deck, retro-quarterly-review) and workflow templates (agent-profiles).
cpe:
  source: cpe
  synthesis_sources:
  ...
  adaptation: CPE-authored command — orchestrates template generation
---

# /scaffold

Generate a project artifact from a CPE template.
