...
Plugin base do CPE. Dependência implícita de todos os demais.

Contém as **convenções** do ambiente, **meta-comandos** do CPE e a **guarda de
design** — o mecanismo que impede a geração de interfaces genéricas.

| Componente | Conteúdo (a partir das fases 5–6) |
|---|---|
| `commands/` | Meta-comandos do CPE (status, doctor, índice de skills) |
| `skills/` | Convenções e guarda anti-genérico |
| `agents/` | Agentes de suporte do próprio CPE |
