...
description: Design token system for UI generation. Defines the canonical token vocabulary (color, typography, spacing, radius, shadow, motion) that all CPE design skills use. Synthesized from Anthropic frontend-design principles and open-design patterns.
cpe:
  source: cpe
  synthesis_sources:
  ...
  adaptation: CPE-authored synthesis — not a copy of any upstream
---

# Design System Tokens

Canonical token vocabulary for UI generation within the CPE ecosystem. All CPE design skills reference these tokens — never raw CSS values.
